...
from .views import AutorCreate, GeneroCreate, LivroCreate, CategoriaCreate, AcervoCreate
from .views import AutorUpdate, GeneroUpdate, LivroUpdate, CategoriaUpdate, AcervoUpdate
from .views import AutorDelete, GeneroDelete, LivroDelete, CategoriaDelete, AcervoDelete
from .views import AutorList, GeneroList, LivroList, CategoriaList, AcervoList
